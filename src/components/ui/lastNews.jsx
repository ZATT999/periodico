  ...
  return (
    <>
      ...
      <article className="flex flex-col justify-center p-3 md:flex-row gap-8 py-6 ">
        ...
        <Link to={`/noticia/${news.id}`} className="overflow-hidden">
          <img
            src={news.image}
            alt={news.title}
            className="h-[300px] w-[400px] m-auto object-cover rounded shadow-md hover:scale-105 transition-all duration-300"
          />
        </Link>
      </article>
    </>
