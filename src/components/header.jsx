...
import { ArrowDownIcon, LogoutIcon, UserIcon } from "./icons"
  ...
  return (
    <header className="z-40 fixed top-0 flex justify-between items-center px-2 ml:px-4 h-15 sm:h-20  w-full m-auto bg-white shadow-lg">
      ...
      <div className="relative flex justify-center gap-2">
        ...
        <div
          className={`absolute top-10 -right-1 bg-white border-1 border-gray-100 rounded-lg  shadow-md  w-45 text-center z-50 tranlate transition-all duration-300 ${
            isModalOpen ? "translate-x-0" : "translate-x-[200%]"
          }`}
        >
