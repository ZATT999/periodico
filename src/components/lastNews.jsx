  ...
  return (
    <>
      ...
      <article className="flex flex-col justify-center p-3 md:flex-row gap-8 py-6 ">
        ...
        <Link
          to={`/noticia/${news.id}`}
          className="overflow-hidden h-[300px] max-w-[400px] w-full m-auto rounded-lg shadow-md"
        >
          <img
            src={news.image}
            alt={news.title}
            className="object-cover rounded-lg h-[300px] max-w-[400px] w-full hover:scale-105 transition-all duration-300"
          />
        </Link>
      </article>
    </>
